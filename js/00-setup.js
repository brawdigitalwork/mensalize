...
const financeiroPagosMirror = document.getElementById("financeiroPagosMirror");
const financeiroPendentesMirror = document.getElementById("financeiroPendentesMirror");
const financeiroAtrasadosMirror = document.getElementById("financeiroAtrasadosMirror");
const financeiroMes = document.getElementById("financeiroMes");
const financeiroStatus = document.getElementById("financeiroStatus");
const btnAtualizarFinanceiroMes = document.getElementById("btnAtualizarFinanceiroMes");
const listaFinanceiroMensal = document.getElementById("listaFinanceiroMensal");
const financeiroListaContador = document.getElementById("financeiroListaContador");
...
const avisoDataInicio = document.getElementById("avisoDataInicio");
const avisoDataFim = document.getElementById("avisoDataFim");
